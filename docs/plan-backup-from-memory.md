...
Prepare the integration for HACS testing and release readiness on branch chore-prepare-for-hacs, keep all internal sh-prefixed identifiers unchanged, and defer public visibility until final validation.
